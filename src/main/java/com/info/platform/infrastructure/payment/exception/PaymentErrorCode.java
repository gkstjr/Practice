...
import com.info.platform.support.exception.ErrorType;
import org.springframework.http.HttpStatus;

import java.util.Arrays;
public enum PaymentErrorCode implements ErrorType {
    ...
    PAYMENT_TIMEOUT(HttpStatus.INTERNAL_SERVER_ERROR, "결제 과정에서 네트워크 시간초과" ),
    PAYMENT_CONFIRM_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "결제 실패" ),
    ;
